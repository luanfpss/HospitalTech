...
A **HospitalTech** é uma empresa fictícia criada para o projeto, focada no desenvolvimento de soluções tecnológicas para melhorar a gestão hospitalar, otimizar processos e garantir segurança no tratamento de dados médicos.
